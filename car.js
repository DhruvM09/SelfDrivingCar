class Car{
    ...
    update(roadBorders ,  traffic){
        ...
        if(this.sensor){
            ...
            if(this.useBrain){
                this.controls.forward = outputs[0] > 0 ? 1 : 0;
                this.controls.left    = outputs[1] > 0 ? 1 : 0;
                this.controls.right   = outputs[2] > 0 ? 1 : 0;
                this.controls.reverse = outputs[3] > 0 ? 1 : 0;
